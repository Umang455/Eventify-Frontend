...
import { addCompanySnippet } from "src/config/api";
import { _isValidEmail } from "src/utils/common";

export const CommunicationSnippetAdd = (props) => {
  const { open, setOpen, getSnippets } = props;
  ...
  async function _onSave() {
    try {
      ...
      let res = await axios.post(addCompanySnippet, data);
      console.log(res);
      setOpen(false);
      getSnippets();
      setTitle("");
