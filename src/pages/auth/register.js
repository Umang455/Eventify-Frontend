...
import { addSystemUser, registerAPI, registerUser } from "src/config/api"; // Ensure this is correctly defined
...
const Page = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, helpers) => {
      try {
        let res = await axios.post(registerUser, { email: values.email, name: values.name, password: values.password });
        ...
        helpers.setErrors({ submit: err.response?.data || "Registration failed" });
